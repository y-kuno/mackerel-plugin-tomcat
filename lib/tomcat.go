...
func (p *TomcatPlugin) GraphDefinition() map[string]mp.Graphs {
	...
	return map[string]mp.Graphs{
		"jvm.memory": {
			...
			Unit:  "bytes",
			Metrics: []mp.Metrics{
				{Name: "free", Label: "free", Diff: true, Stacked: true},
				{Name: "used", Label: "used", Diff: true, Stacked: true},
				{Name: "total", Label: "total", Diff: true},
				{Name: "max", Label: "max", Diff: true},
			},
		},
		"thread.#": {
			...
			Unit:  "integer",
			Metrics: []mp.Metrics{
				{Name: "maxThreads", Label: "max", Diff: true},
				{Name: "currentThreadCount", Label: "current", Diff: true},
				{Name: "currentThreadsBusy", Label: "busy", Diff: true},
			},
		},
		"request.processing_time.#": {
			...
			Unit:  "integer",
			Metrics: []mp.Metrics{
				{Name: "maxTime", Label: "max", Diff: true},
